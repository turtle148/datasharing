...
export const services: Service[] = [
  // ── Before you arrive ────────────────────────────────────────────────────
  {
    ...
    fieldSchema: [
      { id: 'date', type: 'date', label: 'Which day', range: 'stay', prefill: 'arrival', required: true },
      { id: 'people', type: 'stepper', label: 'How many people eating', min: 1, max: 12, prefill: 'party' },
      {
        id: 'needs',
        type: 'checkboxes',
  ...
  },
  {
    ...
    fieldSchema: [
      ...
      { id: 'date', type: 'date', label: 'Arrival date', range: 'stay', prefill: 'arrival', required: true, half: true },
  ...
  },
  {
    ...
    leadTime: 'Order by 6pm the day before',
    description:
      "I'll meet you at the house, show you how everything works, and leave you my number for the rest of the week. Anything you need setting up, tell me here.",
    fieldSchema: [
      { id: 'date', type: 'date', label: 'Which day', range: 'stay', prefill: 'arrival', required: true },
      {
        id: 'setup',
  ...
  // ── Your first evening ───────────────────────────────────────────────────
  {
    ...
    fieldSchema: [
      { id: 'date', type: 'date', label: 'Which evening', range: 'stay', prefill: 'arrival', required: true, half: true },
  ...
  },
  {
    ...
    fieldSchema: [
      ...
      { id: 'people', type: 'stepper', label: 'How many of you', min: 1, max: 9, prefill: 'party', pricePerUnit: 30, freeUnits: 7 },
  ...
  },
  {
    ...
    fieldSchema: [
      ...
      { id: 'date', type: 'date', label: 'Departure date', range: 'stay', prefill: 'departure', required: true, half: true },
